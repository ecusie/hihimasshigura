...
%>
<frameset rows="260,*" frameborder="0">
		<frame src="page/Menu/Top.jsp" name="frame1" title="上フレーム" noresize>
		<frameset cols="400,*,400" frameborder="0">
			<frame src="page/Menu/Menu.jsp" name="frame2" title="左フレーム" noresize>
			<frame src="<%= jsp %>" name="frame3" title="中フレーム">
			<frame src="page/Twitter/Twitter.jsp" name="frame4" title="右フレーム">
		</frameset>
</frameset>
<body>
